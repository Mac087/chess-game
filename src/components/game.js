...
import FallenSoldierBlock from './Fallen.js';
...
export default class Game extends React.Component {
  ...
  handleClick(i){
    ...
    if(this.state.sourceSelection === -1){
      ...
      squares[this.state.sourceSelection].style.backgroundColor = "transparent";
      console.log('background color ', squares[this.state.sourceSelection].style.backgroundColor);
      if(squares[i] && squares[i].player === this.state.player){
        this.setState({
